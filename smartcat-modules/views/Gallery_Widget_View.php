...
<script type="text/javascript">
    ...
    jQuery(document).ready(function(){
        ...
        jQuery(".layla-gallery-contents").unitegallery({
            ...
            <?php if ( get_theme_mod( 'layla_gallery_gutter_space', 5 ) ) : ?>
                tiles_space_between_cols: <?php echo esc_js( get_theme_mod( 'layla_gallery_gutter_space', 5 ) ); ?>,
            <?php endif; ?>
            ...
            <?php if ( get_theme_mod( 'layla_gallery_hover_opacity', .33 ) ) : ?>
                tile_overlay_opacity: <?php echo esc_js( get_theme_mod( 'layla_gallery_hover_opacity', .33 ) ); ?>,
            <?php endif; ?>
            
            <?php if ( get_theme_mod( 'layla_gallery_hover_color', '#ffffff' ) ) : ?>
                tile_overlay_color: "<?php echo esc_js( get_theme_mod( 'layla_gallery_hover_color', '#ffffff' ) ); ?>",
            <?php endif; ?>
...
<div class="layla-gallery <?php echo isset( $instance['scmod_gallery_widget_width'] ) ? 'col-sm-' . $instance['scmod_gallery_widget_width'] : 'col-sm-12'; ?>">
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                ...
                <?php if ( !empty( $gallery ) ) : ?>
                    ...
                    <div id="gallery" style="display:none;" class="layla-gallery-contents">
                ...
                <?php else : ?>
                    ...
                    <h4 class="none-to-display"><?php _e( 'There are currently no photos to display in the Gallery, please check again at a later time.', 'layla' ); ?></h4>
