...
function layla_scripts() {
    ...
    wp_enqueue_style('fontawesome', get_template_directory_uri() . '/inc/css/font-awesome.min.css', array(), LAYLA_VERSION);
    ...
    wp_enqueue_script('wow', get_template_directory_uri() . '/inc/js/wow.min.js', array('jquery'), LAYLA_VERSION, true);
    ...
    <div class="site-info">
        ...
        <div class="row">
            ...
            <div class="payment-icons">
                ...
                <?php if ( get_theme_mod( 'layla_include_cc_visa', true ) ) : ?>
                    <i class="fa fa-cc-visa"></i>
                <?php endif; ?>

                <?php if ( get_theme_mod( 'layla_include_cc_mastercard', true ) ) : ?>
                    <i class="fa fa-cc-mastercard"></i>
                <?php endif; ?>

                <?php if ( get_theme_mod( 'layla_include_cc_amex', true ) ) : ?>
                    <i class="fa fa-cc-amex"></i>
                <?php endif; ?>

                <?php if ( get_theme_mod( 'layla_include_cc_paypal', true ) ) : ?>
